...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 bg-white z-10">
        <div className="flex w-full flex-col justify-end items-center border-b pb-2 hidden md:flex">
        ...
        {/* MOBILE */}
        <div className="flex w-full flex-col justify-end items-center border-b pb-2 md:hidden">
